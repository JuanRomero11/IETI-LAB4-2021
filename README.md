...
[![Deployed to Heroku](https://www.herokucdn.com/deploy/button.png)](https://ieti4.herokuapp.com/)
...
La actualizacion de los datos se puede ver reflejada al inspeccionar la pagina en la opcion Aplicacion.
